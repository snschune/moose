...
PerProcessorRayTracingResultsVectorPostprocessor::execute()
{
  ...
  for (auto & result : _results)
  {
    ...
    {
      case 0: // rays_started
        (*_result_values[0])[_pid] = _study.parallelRayStudy().localObjectsStarted();
        break;
      case 1: // rays_traced
        (*_result_values[1])[_pid] = _study.parallelRayStudy().localObjectsExecuted();
        break;
      ...
      case 4: // buffers_received
        ...
        break;
      case 5: // rays_sent
        (*_result_values[5])[_pid] = _study.parallelRayStudy().objectsSent();
        break;
      case 6: // buffers_sent
      ...
      case 11: // ray_pool_created
        (*_result_values[11])[_pid] = _study.parallelRayStudy().poolObjectsCreated();
        break;
