...
protected:
  ...
  /// Vector of Rays that the user will fill into in defineRays()
  ...
  /// the rays after they have been defined once.
...
private:
  ...
  /// Storage for all of the Rays this processor is responsible for
  std::vector<std::shared_ptr<Ray>> _local_rays;

  /// Whether or not we should call claimRays() on the next generateRays()
